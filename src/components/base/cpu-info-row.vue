<template>
  <div class="cpu-info-row-wrapper column justify-center items-center no-wrap full-width">
    <div class="row justify-start items-center full-width no-wrap">
      <q-icon class="q-mr-xs" name="mdi-cpu-64-bit" size="xs" />
      <span class="text-base-color text-subtitle2 q-mr-xs">
      ...
      <q-badge
        ...
        class="text-base-color text-subtitle2"
        rounded
        color="warning">
    ...
    <div class="row justify-between items-center full-width no-wrap q-mt-sm">
      <div class="row justify-center items-center no-wrap">
        ...
        <span class="text-base-color text-body2">
